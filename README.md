...
!\[Plateforme](https://img.shields.io/badge/Windows-10%2F11-0078D6)
...
* **Photos de groupe gérées** : si plusieurs personnes connues sont présentes, la photo va dans un dossier `Prénom1\\\_Prénom2\\\_…`.
...
|≥ 2 personnes connues|`Prénom1\\\_Prénom2\\\_…` (ordre alphabétique)|
...
toujours dans le même dossier `Alice\\\_Bob`. Au-delà de 6 personnes, le dossier est nommé
`Groupe\\\_<hash>` avec un fichier listant les prénoms.
...
1. Installe **Python 3.12** depuis [https://www.python.org/downloads/windows/](https://www.python.org/downloads/windows/) en cochant
**« Add python.exe to PATH »**.
2. Double-clique **`installer.bat`** (installe les dépendances ; quelques minutes).
3. Double-clique **`lancer.bat`** pour ouvrir l'application.

Aucune commande à taper. Voir [`README\\\_FR.md`](README_FR.md) pour le détail pas à pas et le dépannage.
